...
<head>
	...
	<title>Online Tutorial Service</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Online Tutorial Service</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
                 <!------Navigation menus starts---->
				<ul class="nav navbar-nav navbar-right">
					<li> <a href="">Home</a></li>
					<li> <a href="#myservice_section">Learning</a></li>
				...
				<div class="slider-overlay">
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="cta-div">
								<a href="#foot" class="btn1">CONTACT US</a>
							...
							<div class="social-networks">
								...
								<a href="https://www.instagram.com/crazy_selva_003" class="fa fa-instagram"></a>
								<!-- <a href="" class="fa fa-reddit"></a> -->
								<a href="https://www.linkedin.com/in/selva-s-3a8770249" class="fa fa-linkedin"></a>
...
<!-- 
 ...
 -->
			...
			<section class="work" id="work"><br>
				...
				<p class="text-center">Practice makes a man perfect !</p>
				...
				<div class="row">
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							...
							<div class="team-member text-center">
								<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0e-9L-OuQW5Dqfbaqlpl84ptS0VWZbY1K_A&usqp=CAU" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Selva S</h4>
									<h4 class="team-member-designation">Frontend Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0e-9L-OuQW5Dqfbaqlpl84ptS0VWZbY1K_A&usqp=CAU" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Dharun S</h4>
									<h4 class="team-member-designation">Frontend Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0e-9L-OuQW5Dqfbaqlpl84ptS0VWZbY1K_A&usqp=CAU" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Krishnakumar S</h4>
									<h4 class="team-member-designation">Backend Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												It is an online E-learning website <br>
